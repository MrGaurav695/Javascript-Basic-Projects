...
// to protect your API key. Never expose it in client-side code.
    ...
    savedConversations.forEach(conversation => {
        ...
        const responseHtml = `
           ...
           <div class="message__content">
            ...
            <button class="message__icon hide" aria-label="Copy message"><i class='bx bx-copy-alt'></i></button>
...
chatHistoryContainer.addEventListener('click', (e) => {
    const copyBtn = e.target.closest('.message__icon');
    if (copyBtn) {
        copyMessageToClipboard(copyBtn);
    }
});
...
// Handle click and keyboard on suggestion items
